...
store1 = Shop("Магазин_1","продуктовий" )
print(store1.shop_name)
print(store1.store_type)
store1.describe_shop()
store2 = Shop("Магазин_2","продуктовий")
store2.describe_shop()
store3 = Shop("Магазин_3","продуктовий")
store3.describe_shop()
store4 = Shop("Магазин_4","продуктовий")
...
class Discount(Shop):
     ...
     def get_discount_products(self):
        ...
        for product in self.discount_products:
            print(product)
store_discount = Discount("Знижки", "Продуктовий", ["Хліб", "Молоко", "Капуста"])
